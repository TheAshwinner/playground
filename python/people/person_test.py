...
class PersonTestCase(TestCase):
    def testNextChat(self):
        ...
        user = Person(name="Test Name", frequency=10,
                      last_chat_date=last_chat_date, notes="notes")
        self.assertEqual(user.next_chat_date(), datetime.datetime(
    ...
    def testUpdateLastChat(self):
        ...
        user = Person(name="Test Name", frequency=10,
                      last_chat_date=last_chat_date, notes="notes")
        user.update_last_chat(last_chat_date=datetime.datetime(
